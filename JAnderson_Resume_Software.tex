...
\begin{subfigure}{.3\textwidth}
\centering
\wheelchart{40/gray/Hands-On, 20/lightgray/Mentoring,  40/black/Collaboration}
{
\colorbox{gray}{
...
\begin{entrylist}
	\entry
		...
		{
		 \texttt{SQL}\slashsep\texttt{C\#}\slashsep\texttt{Vue.js}\slashsep\texttt{REST API}\slashsep\texttt{Agile}\slashsep\texttt{Git}\slashsep\texttt{OAuth2}\slashsep\texttt{AWS}\slashsep\texttt{Project Management}\slashsep\texttt{Mentoring}\\\
	 \begin{compactitem}
